package catx.feitu.darknya.graphics.fastrender.tileentity
...
import catx.feitu.darknya.graphics.texture.TextureUtils
import catx.feitu.darknya.graphics.texture.TextureUtils.readImage
...
class ChestRenderBuilder(
    ...
    open class SmallChestRenderBuilder(
        ...
        protected fun upload(
            buffer: ByteBuffer,
            model: catx.feitu.darknya.graphics.fastrender.model.Model,
