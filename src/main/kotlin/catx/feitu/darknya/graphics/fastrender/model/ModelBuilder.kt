package catx.feitu.darknya.graphics.fastrender.model
...
open class ModelBuilder(val id: Int, val textureSizeX: Int, val textureSizeY: Int) {
    ...
    private val childModels = ArrayList<catx.feitu.darknya.graphics.fastrender.model.ChildModelBuilder>()

    var vertexSize = 0; protected set
    inline fun childModel(block: catx.feitu.darknya.graphics.fastrender.model.ChildModelBuilder.() -> Unit) {
        childModel(0.0f, 0.0f, block)
    }

    inline fun childModel(textureOffsetX: Float, textureOffsetY: Float, block: catx.feitu.darknya.graphics.fastrender.model.ChildModelBuilder.() -> Unit) {
        childModel(catx.feitu.darknya.graphics.fastrender.model.ChildModelBuilder(this, textureOffsetX, textureOffsetY).apply(block))
    }

    fun childModel(childModelBuilder: catx.feitu.darknya.graphics.fastrender.model.ChildModelBuilder) {
...
class ChildModelBuilder(parent: catx.feitu.darknya.graphics.fastrender.model.ModelBuilder, private val textureOffsetX: Float, private val textureOffsetY: Float) :
    catx.feitu.darknya.graphics.fastrender.model.ModelBuilder(parent.idCounter++, parent.textureSizeX, parent.textureSizeY) {
    override var idCounter: Int by parent::idCounter

    private val boxList = ArrayList<catx.feitu.darknya.graphics.fastrender.model.ChildModelBuilder.Box>()
