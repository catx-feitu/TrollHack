...
abstract class Model(private val textureSizeX: Int, private val textureSizeZ: Int) {
    ...
    fun init() {
        val builder = catx.feitu.darknya.graphics.fastrender.model.ModelBuilder(0, textureSizeX, textureSizeZ)
        builder.buildModel()
    ...
    protected abstract fun catx.feitu.darknya.graphics.fastrender.model.ModelBuilder.buildModel()
