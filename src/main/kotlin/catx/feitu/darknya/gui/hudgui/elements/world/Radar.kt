...
import catx.feitu.darknya.graphics.RenderUtils2D.drawCircleFilled
import catx.feitu.darknya.graphics.RenderUtils2D.drawCircleOutline
...
import catx.feitu.darknya.manager.managers.ChunkManager
...
internal object Radar : HudElement(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.drawBorder() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.drawEntity() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.drawChunk() {
        RenderUtils2D.prepareGL()
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.drawChunkFilled(playerChunkX: Int, playerChunkZ: Int) {
