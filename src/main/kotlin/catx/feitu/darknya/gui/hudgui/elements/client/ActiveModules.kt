...
import catx.feitu.darknya.graphics.color.ColorUtils
...
internal object ActiveModules : HudElement(
    ...
    private enum class SortingMode(
        ...
        val keySelector: (catx.feitu.darknya.module.AbstractModule) -> Comparable<*>
    ) : DisplayEnum {
    ...
    private fun makeKeyPair(modules: List<catx.feitu.darknya.module.AbstractModule>, old: Array<SortingPair>?): Array<SortingPair> {
    ...
    private val catx.feitu.darknya.module.AbstractModule.textLine
        get() = textLineMap.getOrPut(this.id) {
            this.newTextLine()
        }

    private fun catx.feitu.darknya.module.AbstractModule.newTextLine(color: ColorRGB = GuiSetting.primary) =
    ...
    private class ModuleToggleFlag(val module: catx.feitu.darknya.module.AbstractModule) : TimedFlag<Boolean>(module.state) {
        fun update() {
            value = module.state
        }
    }

    private val catx.feitu.darknya.module.AbstractModule.state: Boolean
