...
object CombatManager : Manager() {
    private val combatModules: List<catx.feitu.darknya.module.AbstractModule>
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateCrystalDamage() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updatePlaceMap(contextSelf: CalcContext, contextTarget: CalcContext?, remove: Boolean) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateCrystalMap(
    ...
    fun isActiveAndTopPriority(module: catx.feitu.darknya.module.AbstractModule) = module.isActive() && isOnTopPriority(module)
    ...
    fun getTopModule(): catx.feitu.darknya.module.AbstractModule? {
        var topModule: catx.feitu.darknya.module.AbstractModule? = null
    ...
    init {
        val cacheList = ArrayList<catx.feitu.darknya.module.AbstractModule>()
