...
object HoleManager : Manager() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.removeInvalidPos() {
        val playerPos = player.flooredPosition
        var modified = false
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updatePos(force: Boolean) {
        val playerPos = player.flooredPosition
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updatePosSequence(sequence: Sequence<BlockPos.MutableBlockPos>) {
        val playerPos = player.flooredPosition
        val checked = LongOpenHashSet()
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updatePos(
        playerPos: BlockPos,
        checked: LongSet,
