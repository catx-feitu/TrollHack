...
object CommandManager : catx.feitu.darknya.command.AbstractCommandManager<catx.feitu.darknya.event.ClientExecuteEvent>(), AsyncLoader<List<Class<out ClientCommand>>> {
    ...
    override fun register(builder: CommandBuilder<catx.feitu.darknya.event.ClientExecuteEvent>): Command<catx.feitu.darknya.event.ClientExecuteEvent> {
    ...
    override fun unregister(builder: CommandBuilder<catx.feitu.darknya.event.ClientExecuteEvent>): Command<catx.feitu.darknya.event.ClientExecuteEvent>? {
        synchronized(lockObject) {
    ...
    fun runCommand(string: String) {
        ConcurrentScope.launch {
            ...
            try {
                try {
                    invoke(catx.feitu.darknya.event.ClientExecuteEvent(args))
    ...
    override suspend fun invoke(event: catx.feitu.darknya.event.ClientExecuteEvent) {
