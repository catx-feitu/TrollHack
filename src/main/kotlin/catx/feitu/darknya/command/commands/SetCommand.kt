...
object SetCommand : ClientCommand(
    ...
    private val moduleSettingMap: Map<catx.feitu.darknya.module.AbstractModule, Map<String, AbstractSetting<*>>> by AsyncCachedValue(
        5L,
        TimeUnit.SECONDS
    ) {
    ...
    private val hudElementSettingMap: Map<AbstractHudElement, Map<String, AbstractSetting<*>>> by AsyncCachedValue(
        ...
        catx.feitu.darknya.gui.GuiManager.hudElements
    ...
    private fun getSetting(module: catx.feitu.darknya.module.AbstractModule, settingName: String) =
