...
internal object AutoEat : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.shouldEat() =
        player.foodStats.foodLevel < belowHunger
            || player.scaledHealth < belowHealth

    private fun catx.feitu.darknya.event.SafeClientEvent.eat(hand: EnumHand) {
     ...
     */
    private fun catx.feitu.darknya.event.SafeClientEvent.swapToFood(): Boolean {
     ...
     * @return `true` if food found and moved
     */
    private fun catx.feitu.darknya.event.SafeClientEvent.moveFoodToHotbar(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isValid(itemStack: ItemStack): Boolean {
