...
internal object NoteBot : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.playNotes(notes: List<Note>) {
        for (note in notes) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.clickBlock(pos: BlockPos) {
