...
internal object FastSwim : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.runFastSwim(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isInLiquid(material: Material): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.lavaSwim() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.waterSwim() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.ySwim(vBoost: Float, upSpeed: Float, downSpeed: Float) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.stopMotion() {
        player.motionX = 0.0
        player.motionZ = 0.0
        moveSpeed = 0.0
    }
