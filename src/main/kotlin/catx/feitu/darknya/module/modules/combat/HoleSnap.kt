...
internal object HoleSnap : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.shouldDisable(currentSpeed: Double) =
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.findHole(): HoleInfo? {
