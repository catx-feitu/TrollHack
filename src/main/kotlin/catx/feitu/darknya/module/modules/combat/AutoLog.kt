...
internal object AutoLog : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkTotems(): Boolean {
        val slots = player.allSlots
        return slots.any { it.hasStack }
            && slots.countItem(Items.TOTEM_OF_UNDYING) < minTotems
    }

    private fun catx.feitu.darknya.event.SafeClientEvent.checkCrystals(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkCreeper(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkPlayers(): Boolean {
        for (entity in EntityManager.entity) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.log(reason: Reasons, additionalInfo: String = "") {
