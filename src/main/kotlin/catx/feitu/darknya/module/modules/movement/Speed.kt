package catx.feitu.darknya.module.modules.movement
...
import catx.feitu.darknya.manager.managers.HoleManager
import catx.feitu.darknya.manager.managers.TimerManager.modifyTimer
import catx.feitu.darknya.manager.managers.TimerManager.resetTimer
...
internal object Speed : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.handleVelocity(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.shouldStrafe(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateState(baseSpeed: Double, motionX: Double, motionZ: Double) {
        if (player.onGround) {
            state = State.JUMP
        }
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.smartJump(motionX: Double, motionZ: Double) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.holeCheck(motionX: Double, motionZ: Double, dist: Double): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcBlockDistAhead(offsetX: Double, offsetZ: Double): Double {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.jump() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcJumpMotion(): Double {
        val motion = when {
            isBurrowed() -> 0.42
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateFinalSpeed(baseSpeed: Double) {
        if (!isBurrowed()) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.applyVelocityBoost() {
        if (isBurrowed()) {
            resetBoost()
        } else {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateVelocityBoost() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcStepHeight(dist: Double, motionX: Double, motionZ: Double): Double {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkBox(minStepHeight: Double, offsetX: Double, offsetZ: Double): Double {
