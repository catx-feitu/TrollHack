...
internal object AutoEZ : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateAttackedPlayer() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.removeInvalidPlayers() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.sendEzMessage() {
