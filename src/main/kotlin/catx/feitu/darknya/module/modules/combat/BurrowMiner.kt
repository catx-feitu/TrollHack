...
internal object BurrowMiner : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.mineBurrow(target: EntityLivingBase) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.mineCorner(target: EntityLivingBase) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getClipPos(target: EntityLivingBase): BlockPos? {
