...
internal object AutoFish : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isStabled(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isOnWater(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isSplash(packet: SPacketSoundEffect): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isBouncing(): Boolean {
