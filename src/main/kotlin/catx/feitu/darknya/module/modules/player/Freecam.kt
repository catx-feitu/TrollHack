...
internal object Freecam : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.spawnCameraGuy() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updatePlayerRotation() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updatePlayerMovement() {
