...
internal object BreakWarning : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getPlayer(id: Int): EntityPlayer? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.trySendBurrow(packet: SPacketBlockBreakAnim, player: EntityPlayer): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.trySendSurround(packet: SPacketBlockBreakAnim, player: EntityPlayer): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.trySendNearby(packet: SPacketBlockBreakAnim, player: EntityPlayer): Boolean {
