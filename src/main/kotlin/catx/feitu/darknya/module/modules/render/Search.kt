...
internal object Search : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateRenderer() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getBlockColor(pos: BlockPos, blockState: IBlockState): ColorRGB {
