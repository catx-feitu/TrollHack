...
internal object HolePathFinder : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.check(): Deque<PathFinder.PathNode>? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.moveTeleport(path: Deque<PathFinder.PathNode>) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.moveLegit(event: PlayerMoveEvent.Pre, path: Deque<PathFinder.PathNode>) {
        val baseSpeed = player.applySpeedPotionEffects(0.2873)
        var countDown = 20
        var motionX = 0.0
        var motionZ = 0.0
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.clearPreviousNode(path: Deque<PathFinder.PathNode>): Boolean {
        do {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calculatePath() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.dumpWorld(): LongSet {
