...
import catx.feitu.darknya.process.AutoObsidianProcess
...
internal object AutoObsidian : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.runAutoObby() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateState() {
        if (state != State.DONE) {
            updatePlacingPos()
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updatePlacingPos() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isPositionValid(pos: BlockPos, blockState: IBlockState, eyePos: Vec3d) =
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateMainState() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.startPlacing() =
     ...
     */
    private fun catx.feitu.darknya.event.SafeClientEvent.canPickUpObby(): Boolean {
     ...
     */
    private fun catx.feitu.darknya.event.SafeClientEvent.checkObbyCount() =
        when (fillMode) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.countInventory() =
        player.inventorySlots.countBlock(Blocks.OBSIDIAN)

    private fun catx.feitu.darknya.event.SafeClientEvent.countDropped() =
        getDroppedItems(Blocks.OBSIDIAN.id, 8.0f).sumOf { it.item.count }

    private fun catx.feitu.darknya.event.SafeClientEvent.countEmptySlots(): Int {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateSearchingState() {
        if (state == State.SEARCHING) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.searchingState() {
        if (searchShulker) {
            when (searchingState) {
                SearchingState.PLACING -> {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placeShulker(pos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placeEnderChest(pos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.openShulker(pos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placeBlock(pos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.mineBlock(pos: BlockPos, pre: Boolean) {
     ...
     * disable the module.
     */
    private fun catx.feitu.darknya.event.SafeClientEvent.swapToValidPickaxe(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.onInventoryOperation() {
        delayTimer.reset(20L)
        playerController.updateController()
    }

    private fun catx.feitu.darknya.event.SafeClientEvent.collectDroppedItem(itemId: Int) {
