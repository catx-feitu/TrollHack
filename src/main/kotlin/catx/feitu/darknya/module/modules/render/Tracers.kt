...
internal object Tracers : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getColor(entity: Entity): ColorRGB {
        val color = when {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getRangedColor(entity: Entity, color: ColorRGB): ColorRGB {
