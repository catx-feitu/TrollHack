...
internal object Step : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.shouldRunStep(x: Double, y: Double, z: Double): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.vanillaStep() {
        player.stepHeight = maxHeight
        StepEvent.post()
        shouldDisable = autoDisable
    }

    private fun catx.feitu.darknya.event.SafeClientEvent.packetStep(stepHeight: Double) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcStepHeight(event: PlayerMoveEvent.Pre): Double {
