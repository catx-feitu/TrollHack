...
internal object Surround : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isSurroundPlaceable(holePos: BlockPos): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updatePlacingMap(playerPos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.runPlacing() {
        var placeCount = 0
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getNeighbor(pos: BlockPos): PlaceInfo? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placeBlock(placeInfo: PlaceInfo) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getSlot(): Slot? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkRotation(placeInfo: PlaceInfo): Boolean {
