...
import catx.feitu.darknya.mixins.core.world.MixinBlockSoulSand
import catx.feitu.darknya.mixins.core.world.MixinBlockWeb
...
internal object NoSlowDown : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.packetNoSlow(): Boolean {
