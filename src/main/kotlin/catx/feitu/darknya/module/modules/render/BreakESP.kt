...
internal object BreakESP : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getBoundingBox(pos: BlockPos, progress: Int): AxisAlignedBB {
        return getBoundingBox(pos).scale(progress / 10.0)
    }


    private fun catx.feitu.darknya.event.SafeClientEvent.getBoundingBox(pos: BlockPos): AxisAlignedBB {
