...
internal object AutoArmor : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.equipArmor(armorSlots: List<Slot>, bestArmors: Array<Pair<Slot, Float>>): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.moveStackedArmor(slotFrom: Slot, slotTo: Slot): InventoryTask {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.moveFromInventory(slotFrom: Slot, slotTo: Slot): InventoryTask {
        return when {
            !slotTo.hasStack -> {
                inventoryTask {
