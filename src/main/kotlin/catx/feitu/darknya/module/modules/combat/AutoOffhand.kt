...
internal object AutoOffhand : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getType() = when {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkTotem() = player.scaledHealth < staticHp
        || (checkDamage && player.scaledHealth - lastDamage <= damageHp)

    private fun catx.feitu.darknya.event.SafeClientEvent.checkGapple() = offhandGapple
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkStrength() = offhandStrength
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.switchToType(typeOriginal: Type?, alternativeType: Boolean = false) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkOffhandItem(type: Type) = type.filter(player.heldItemOffhand)

    private fun catx.feitu.darknya.event.SafeClientEvent.getItemSlot(type: Type, attempts: Int): Pair<Slot, Type>? =
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getSlot(type: Type): Slot? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateDamage() {
        var maxDamage = 0.0f
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getMobDamage(): Float {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getPlayerDamage(): Float {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getArrowDamage(): Float {
    ...
    private val catx.feitu.darknya.event.SafeClientEvent.nextFallDist get() = player.fallDistance - (player.posY - player.prevPosY).toFloat()
}