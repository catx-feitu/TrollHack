...
internal object EntitySpeed : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.steerEntity(entity: Entity) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isBorderingChunk(entity: Entity, motionX: Double, motionZ: Double): Boolean {
