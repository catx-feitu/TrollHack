...
internal object AutoCity : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateTargetInfo() {
        targetInfo = calcTargetInfo()
    }

    private fun catx.feitu.darknya.event.SafeClientEvent.calcTargetInfo(): TargetInfo? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcSequence(
        targetPos: BlockPos,
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcInPlaceSequence(
        targetPos: BlockPos,
    ): Sequence<Pair<BlockPos, BlockPos>> {
        val playerPos = player.betterPosition
        val eyePos = player.eyePosition
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placeCrystal(targetPos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placeAnvil(targetPos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.breakCrystal(entityID: Int) {
