...
import catx.feitu.darknya.graphics.buffer.PersistentMappedVBO
import catx.feitu.darknya.graphics.color.ColorRGB
import catx.feitu.darknya.graphics.esp.DynamicBoxRenderer
import catx.feitu.darknya.graphics.shaders.DrawShader
import catx.feitu.darknya.graphics.use
...
internal object ESP : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateBoxESP() {
        val rangeSq = range.sq
