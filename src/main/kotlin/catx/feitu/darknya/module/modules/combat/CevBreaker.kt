...
internal object CevBreaker : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.safeCheck(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcTarget(): Info? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.wallCheck(pos: BlockPos): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.place(info: Info) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.breakCrystal(id: Int) {
