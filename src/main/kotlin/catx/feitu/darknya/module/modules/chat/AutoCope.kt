...
internal object AutoCope : Module(
    ...
    private val catx.feitu.darknya.event.SafeClientEvent.isHoldingTotem: Boolean
    ...
    private class CopeReply(settingName: String, val detect: catx.feitu.darknya.event.SafeClientEvent.(String) -> Boolean) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.targeting(message: String): Boolean {
