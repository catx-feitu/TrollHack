package catx.feitu.darknya.module.modules.player
...
import catx.feitu.darknya.manager.managers.HotbarSwitchManager
...
import catx.feitu.darknya.manager.managers.PlayerPacketManager
...
internal object PacketMine : Module(
    ...
    private val miningQueue = HashMap<catx.feitu.darknya.module.AbstractModule, MiningTask>().synchronized()
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.finishMining(blockState: IBlockState, miningInfo: MiningInfo): Boolean {
    ...
    fun mineBlock(module: catx.feitu.darknya.module.AbstractModule, pos: BlockPos, priority: Int, once: Boolean = false) {
        runSafe {
    ...
    fun reset(module: catx.feitu.darknya.module.AbstractModule) {
        runSafe {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateMining() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.startMining(task: MiningTask) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkRotation(miningInfo: MiningInfo): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcBreakTime(pos: BlockPos): Int {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getBreakSpeed(blockState: IBlockState): Float {
        var maxSpeed = 1.0f
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.sendMiningPacket(miningInfo: MiningInfo, end: Boolean) {
    ...
    private class MiningTask(val owner: catx.feitu.darknya.module.AbstractModule, val pos: BlockPos, val priority: Int, val once: Boolean) :
    ...
    private class MiningInfo(
        event: catx.feitu.darknya.event.SafeClientEvent,
        val owner: catx.feitu.darknya.module.AbstractModule,
        ...
        fun updateLength(event: catx.feitu.darknya.event.SafeClientEvent) {
