...
internal object BossStack : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateBossInfoMap() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getMatchBoss(list: Collection<BossInfoClient>, name: String? = null): BossInfoClient? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getClosestBoss(name: String?): EntityLivingBase? {
