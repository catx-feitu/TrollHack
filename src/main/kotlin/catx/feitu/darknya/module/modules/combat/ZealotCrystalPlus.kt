...
import catx.feitu.darknya.graphics.ESPRenderer
...
import catx.feitu.darknya.graphics.color.ColorRGB
import catx.feitu.darknya.graphics.color.setGLColor
...
internal object ZealotCrystalPlus : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkBreakDamage(
        crystalX: Double,
        crystalY: Double,
        crystalZ: Double,
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkPausing(): Boolean {
        return eatingPause && player.isHandActive && player.activeItemStack.item is ItemFood
    }

    private fun catx.feitu.darknya.event.SafeClientEvent.doBreak(placeInfo: PlaceInfo) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getCrystalList(): List<EntityEnderCrystal> {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getCrystal(crystalList: List<EntityEnderCrystal>): EntityEnderCrystal? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkCrystalRotation(x: Double, y: Double, z: Double): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.doPlace(placeInfo: PlaceInfo) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placeDirect(placeInfo: PlaceInfo) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.breakDirect(x: Double, y: Double, z: Double, entityID: Int) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getWeaponSlot(): HotbarSlot? {
    ...
    @Suppress("DuplicatedCode")
    private fun catx.feitu.darknya.event.SafeClientEvent.calcPlaceInfo(checkRotation: Boolean): PlaceInfo? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getTargets(): Sequence<TargetInfo> {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getTargetInfo(entity: EntityLivingBase, ticks: Int): TargetInfo {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.canMove(box: AxisAlignedBB, x: Double, y: Double, z: Double): AxisAlignedBB? {
        return box.offset(x, y, z).takeIf { !world.collidesWithAnyBlock(it) }
    }

    private fun catx.feitu.darknya.event.SafeClientEvent.shouldForcePlace(entity: EntityLivingBase): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getRawPosList(): List<BlockPos> {
        val mutableBlockPos = BlockPos.MutableBlockPos()
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getPlaceablePos(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getCollidingEntities(
        rangeSq: Float,
        feetXInt: Int,
        feetYInt: Int,
        feetZInt: Int,
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkBreakRange(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isPlaceable(
        pos: BlockPos,
        mutableBlockPos: BlockPos.MutableBlockPos
    ): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcDamage(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcRawDamage(
        entityPos: Vec3d,
        entityBox: AxisAlignedBB,
        posX: Double,
        posY: Double,
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getExposureAmount(
        entityBox: AxisAlignedBB,
        posX: Double,
        posY: Double,
        posZ: Double,
    ...
    private open class PlaceInfo(
        ...
        class Mutable(
            ...
            fun calcPlacement(event: catx.feitu.darknya.event.SafeClientEvent) {
                event {
