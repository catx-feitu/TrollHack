...
internal object Sprint : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkCriticals(event: PacketEvent) =
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkMovementInput(): Boolean {
