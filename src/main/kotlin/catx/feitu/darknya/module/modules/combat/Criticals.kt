...
internal object Criticals : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.jumpAndCancel(event: PlayerAttackEvent, cooldownReady: Boolean, motion: Double?) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.canDoCriticals(onGround: Boolean) =
        onGround
            && !player.isInWeb
            && !player.isOnLadder
            && !player.isRiding
