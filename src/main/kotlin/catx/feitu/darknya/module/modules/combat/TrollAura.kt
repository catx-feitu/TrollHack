...
import catx.feitu.darknya.manager.managers.*
...
import catx.feitu.darknya.manager.managers.HotbarSwitchManager.ghostSwitch
import catx.feitu.darknya.manager.managers.HotbarSwitchManager.serverSideItem
import catx.feitu.darknya.manager.managers.PlayerPacketManager.sendPlayerPacket
...
internal object TrollAura : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateDdosQueue() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.doRotation() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.runLoop() {
        CombatManager.target?.let { target ->
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.doBreak() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.preBreak(entityID: Int): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.breakDirect(packet: CPacketUseEntity) {
        breakTimer.reset()
        inactiveTicks = 0
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.swingHand() {
    ...
    /* Placing */
    private fun catx.feitu.darknya.event.SafeClientEvent.antiSurround(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getAntiSurroundPos(
        surroundPos: BlockPos,
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getAlternativePos(
        surroundPos: BlockPos,
        placeOn: Boolean,
        mutableBlockPos: BlockPos.MutableBlockPos
    ): BlockPos? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.antiSurroundBreakCrystal(pos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkAntiSurroundPos(
        surroundPos: BlockPos,
        pos: BlockPos,
        mutableBlockPos: BlockPos.MutableBlockPos
    ): CrystalDamage? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.antiSurroundDirect(pos: BlockPos, canSwap: Boolean) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.doPlace() {
        if (!canPlace()) return
        val mutableBlockPos = BlockPos.MutableBlockPos()
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placeDirect(canSwap: Boolean, pos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placePacket(pos: BlockPos, hand: EnumHand): CPacketPlayerTryUseItemOnBlock {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.predictBreak(pos: BlockPos) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.canPlace() =
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getPlacingPos(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getOverridePos(
        checkRotation: Boolean,
        mutableBlockPos: BlockPos.MutableBlockPos
    ): CrystalDamage? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getNormalPos(
        checkRotation: Boolean,
        mutableBlockPos: BlockPos.MutableBlockPos
    ): CrystalDamage? {
        val contextSelf = CombatManager.contextSelf ?: return null
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkPos(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.placeDistCheck(
        eyePos: Vec3d,
        crystalDamage: CrystalDamage,
        mutableBlockPos: BlockPos.MutableBlockPos
    ): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.prePlace(pos: BlockPos, mutableBlockPos: BlockPos.MutableBlockPos): Boolean {
        val mode = placeMode
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getPlaceSide(pos: BlockPos): EnumFacing {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getBreakCrystal(): Pair<EntityEnderCrystal, CrystalDamage>? {
        val eyePos = player.eyePosition
        val mutableBlockPos = BlockPos.MutableBlockPos()
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkCrystalRotation(crystalDamage: CrystalDamage): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkDamageBreak(
        crystalDamage: CrystalDamage,
        mutableBlockPos: BlockPos.MutableBlockPos
    ): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.shouldForceBreak(
        crystalDamage: CrystalDamage,
        mutableBlockPos: BlockPos.MutableBlockPos
    ): Boolean {
    ...
    /* General */
    private fun catx.feitu.darknya.event.SafeClientEvent.getHandNullable(): EnumHand? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.noSuicideCheck(crystalDamage: CrystalDamage): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isHoldingTool(): Boolean {
