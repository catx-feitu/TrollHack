...
import catx.feitu.darknya.graphics.esp.DynamicBoxRenderer
import catx.feitu.darknya.graphics.esp.DynamicTracerRenderer
import catx.feitu.darknya.graphics.esp.StaticBoxRenderer
import catx.feitu.darknya.graphics.esp.StaticTracerRenderer
import catx.feitu.darknya.graphics.mask.SideMask
...
internal object StorageESP : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateTileEntities() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateEntities() {
        val eyePos = player.eyePosition
        val rangeSq = range.sq
