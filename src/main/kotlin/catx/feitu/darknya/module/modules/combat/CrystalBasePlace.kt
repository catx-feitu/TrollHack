...
internal object CrystalBasePlace : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.prePlace(minDamageInc: Float) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getPlaceInfo(eyePos: Vec3d, posList: List<BlockPos>, minDamageInc: Float): PlaceInfo? {
