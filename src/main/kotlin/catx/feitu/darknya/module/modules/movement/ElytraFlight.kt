...
internal object ElytraFlight : Module(
    ...
    /* Generic Functions */
    private fun catx.feitu.darknya.event.SafeClientEvent.stateUpdate(event: PlayerTravelEvent) {
        /* Elytra Check */
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.reset(cancelFlying: Boolean) {
        wasInLiquid = false
        isFlying = false
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.holdPlayer(event: PlayerTravelEvent) {
        event.cancel()
        mc.timer.tickLength = 50.0f
    ...
    /* Auto landing */
    private fun catx.feitu.darknya.event.SafeClientEvent.landing(event: PlayerTravelEvent) {
        when {
            player.onGround -> {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.takeoff(event: PlayerTravelEvent) {
     ...
     */
    private fun catx.feitu.darknya.event.SafeClientEvent.getYaw(): Double {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.setSpeed(yaw: Double, boosting: Boolean) {
    ...
    /* Boost mode */
    private fun catx.feitu.darknya.event.SafeClientEvent.boostMode() {
    ...
    /* Control Mode */
    private fun catx.feitu.darknya.event.SafeClientEvent.controlMode(event: PlayerTravelEvent) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.upwardFlight(currentSpeed: Double, yaw: Double) {
    ...
    /* Creative Mode */
    private fun catx.feitu.darknya.event.SafeClientEvent.creativeMode() {
        if (player.onGround) {
            reset(true)
            return
        }
    ...
    /* Packet Mode */
    private fun catx.feitu.darknya.event.SafeClientEvent.packetMode(event: PlayerTravelEvent) {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.spoofRotation() {
