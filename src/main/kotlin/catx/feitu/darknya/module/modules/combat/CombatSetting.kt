...
import catx.feitu.darknya.process.PauseProcess.pauseBaritone
import catx.feitu.darknya.process.PauseProcess.unpauseBaritone
...
internal object CombatSetting : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkDigging() =
        pauseForDigging.value
            && player.heldItemMainhand.item is ItemPickaxe
            && playerController.isHittingBlock

    private fun catx.feitu.darknya.event.SafeClientEvent.checkEating() =
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateTarget() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getTargetList(): Set<EntityLivingBase> {
        val eyePos = player.eyePosition
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcHoleFactor(entity: EntityLivingBase): Float {
