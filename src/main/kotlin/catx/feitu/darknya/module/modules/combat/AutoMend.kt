...
internal object AutoMend : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.preCheck(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkNearbyPlayers(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateArmorSlots() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.findXp(): HotbarSlot? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.findAndMoveArmor() {
        var count = 0
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.moveArmor(slot: Slot): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateInHole() {
