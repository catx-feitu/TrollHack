...
internal object Scaffold : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.sendSetbackPacket() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getBlockSlot(): HotbarSlot? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateSequence() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.calcSortedOffsets(): Array<Vec2d> {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getSequence(feetPos: BlockPos): List<PlaceInfo>? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isTowering(): Boolean {
