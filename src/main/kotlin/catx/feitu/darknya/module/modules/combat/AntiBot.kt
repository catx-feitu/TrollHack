...
internal object AntiBot : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkBot(entity: EntityPlayer): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.hoverCheck(entity: EntityPlayer): Boolean {
