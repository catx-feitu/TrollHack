...
internal object AutoTrap : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.canRun(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getObby(): HotbarSlot? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.runAutoTrap() = ConcurrentScope.launch {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getStructurePlaceInfo(
        center: BlockPos,
    ...
    private suspend fun catx.feitu.darknya.event.SafeClientEvent.doPlace(
        placeInfo: PlaceInfo,
        slot: HotbarSlot
    ) {
