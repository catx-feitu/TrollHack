...
internal object ElytraFlightNew : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.onGround() {
        player.setFlag(7, false)
        resetTimer()
    }

    private fun catx.feitu.darknya.event.SafeClientEvent.takeoff() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.fly(event: PlayerMoveEvent.Pre) {
        player.motionY = 0.0
