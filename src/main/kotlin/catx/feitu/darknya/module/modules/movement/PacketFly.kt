...
internal object PacketFly : Module(
    ...
    private class SpoofSetting(
        ...
        fun offset(event: catx.feitu.darknya.event.SafeClientEvent): Double {
            event {
                when (mode) {
                    SpoofMode.CONSTANT -> {
                        return constant
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.updateSmartToggle() {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.isPhasing(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.sendPlayerPacket(packet: CPacketPlayer) {
