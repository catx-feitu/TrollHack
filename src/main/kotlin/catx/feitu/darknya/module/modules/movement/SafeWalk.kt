...
import catx.feitu.darknya.mixins.core.entity.MixinEntity
...
internal object SafeWalk : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkFallDist(posX: Double, posZ: Double): Boolean {
