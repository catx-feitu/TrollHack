...
internal object ChestStealer : Module(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.canSteal(): Boolean {
        return getStealingSlot() != null
    }

    private fun catx.feitu.darknya.event.SafeClientEvent.canStore(): Boolean {
        return getStoringSlot() != null
    }

    private fun catx.feitu.darknya.event.SafeClientEvent.isContainerOpen(): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.stealOrStore(slot: Slot?, containerMode: ContainerMode): Boolean {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getStealingSlot(): Slot? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.getStoringSlot(): Slot? {
        val container = player.openContainer
