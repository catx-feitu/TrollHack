...
object ModuleManager : AsyncLoader<List<Class<out catx.feitu.darknya.module.AbstractModule>>>, Helper {
    override var deferred: Deferred<List<Class<out catx.feitu.darknya.module.AbstractModule>>>? = null

    private val moduleSet = AliasSet<catx.feitu.darknya.module.AbstractModule>()
    ...
    override suspend fun preLoad0(): List<Class<out catx.feitu.darknya.module.AbstractModule>> {
        val classes = AsyncLoader.classes.await()
        val list: List<Class<*>>

        val time = measureTimeMillis {
            val clazz = catx.feitu.darknya.module.AbstractModule::class.java
        ...
        return list as List<Class<out catx.feitu.darknya.module.AbstractModule>>
    }

    override suspend fun load0(input: List<Class<out catx.feitu.darknya.module.AbstractModule>>) {
        val time = measureTimeMillis {
            for (clazz in input) {
    ...
    internal fun register(module: catx.feitu.darknya.module.AbstractModule) {
    ...
    internal fun unregister(module: catx.feitu.darknya.module.AbstractModule) {
