...
import catx.feitu.darknya.translation.ITranslateSrc
import catx.feitu.darknya.translation.TranslateSrc
...
open class AbstractModule(
    ...
    val category: catx.feitu.darknya.module.Category,
    description: String,
    ...
    Comparable<catx.feitu.darknya.module.AbstractModule> {
    ...
    val id = catx.feitu.darknya.module.AbstractModule.Companion.idRegistry.register()
    ...
    val bind = BindSetting(settingName("Bind"), Bind(), { !alwaysEnabled }, {
        when (onHold.value) {
            catx.feitu.darknya.module.AbstractModule.OnHold.OFF -> if (it) toggle()
            catx.feitu.darknya.module.AbstractModule.OnHold.ENABLE -> toggle(it)
            catx.feitu.darknya.module.AbstractModule.OnHold.DISABLE -> toggle(!it)
        }
    }).also(::addSetting)
    private val onHold = EnumSetting(settingName("On Hold"), catx.feitu.darknya.module.AbstractModule.OnHold.OFF).also(::addSetting)
    ...
    override fun compareTo(other: catx.feitu.darknya.module.AbstractModule): Int {
    ...
    init {
        ...
        default.valueListeners.add { _, it ->
            if (it) {
                ...
                default.value = false
                NoSpamMessage.sendMessage(catx.feitu.darknya.module.AbstractModule.Companion, "$chatName ${catx.feitu.darknya.module.AbstractModule.Companion.defaultMessage}!")
            }
        }
    }
