...
object CrystalUtils {
    ...
    fun catx.feitu.darknya.event.SafeClientEvent.canPlaceCrystal(
    ...
    fun catx.feitu.darknya.event.SafeClientEvent.canPlaceCrystalOn(pos: BlockPos): Boolean {
        val block = world.getBlockState(pos).block
        return block == Blocks.BEDROCK || block == Blocks.OBSIDIAN
    }

    fun catx.feitu.darknya.event.SafeClientEvent.hasValidSpaceForCrystal(
        pos: BlockPos,
        mutableBlockPos: BlockPos.MutableBlockPos = cacheBlockPos.get()
    ): Boolean {
