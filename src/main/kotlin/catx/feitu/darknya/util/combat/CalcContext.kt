...
class CalcContext(
    private val event: catx.feitu.darknya.event.SafeClientEvent,
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.countSamplePoints(
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.countSamplePointsOptimized(
        samplePoints: Array<Vec3d>,
        box: AxisAlignedBB,
        crystalX: Double,
        crystalY: Double,
