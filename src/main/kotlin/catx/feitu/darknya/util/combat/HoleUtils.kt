...
object HoleUtils {
    ...
    fun catx.feitu.darknya.event.SafeClientEvent.checkHoleM(pos: BlockPos): HoleInfo {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkHole1(pos: BlockPos, mutablePos: BlockPos.MutableBlockPos): HoleInfo? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkHole2(pos: BlockPos, mutablePos: BlockPos.MutableBlockPos): HoleInfo? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkHole4(pos: BlockPos, mutablePos: BlockPos.MutableBlockPos): HoleInfo? {
    ...
    private fun catx.feitu.darknya.event.SafeClientEvent.checkSurroundPos(
        pos: BlockPos,
        mutablePos: BlockPos.MutableBlockPos,
