...
object EntityUtils {
    ...
    val catx.feitu.darknya.event.SafeClientEvent.viewEntity get() = mc.renderViewEntity ?: player
    ...
    fun catx.feitu.darknya.event.SafeClientEvent.getDroppedItems(itemId: Int, range: Float): ArrayList<EntityItem> {
    ...
    fun catx.feitu.darknya.event.SafeClientEvent.getDroppedItem(itemId: Int, range: Float) =
