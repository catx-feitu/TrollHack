package catx.feitu.darknya.util.math
...
object RotationUtils {
    ...
    fun catx.feitu.darknya.event.SafeClientEvent.faceEntityClosest(entity: Entity) {
        val rotation = getRotationToEntityClosest(entity)
        player.setRotation(rotation)
    }

    fun catx.feitu.darknya.event.SafeClientEvent.getRelativeRotation(entity: Entity): Float {
        return getRelativeRotation(entity.eyePosition)
    }

    fun catx.feitu.darknya.event.SafeClientEvent.getRelativeRotation(posTo: Vec3d): Float {
    ...
    fun catx.feitu.darknya.event.SafeClientEvent.getRotationToEntityClosest(entity: Entity): Vec2f {
    ...
    fun catx.feitu.darknya.event.SafeClientEvent.getRotationToEntity(entity: Entity): Vec2f {
     ...
     */
    fun catx.feitu.darknya.event.SafeClientEvent.getRotationTo(posTo: Vec3d): Vec2f {
        return getRotationTo(player.getPositionEyes(1f), posTo)
    }

    fun catx.feitu.darknya.event.SafeClientEvent.getYawTo(posTo: Vec3d): Float {
