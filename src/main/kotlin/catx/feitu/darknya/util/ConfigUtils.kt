...
import catx.feitu.darknya.manager.managers.MacroManager
...
object ConfigUtils {
    ...
    fun loadAll(): Boolean {
        var success = catx.feitu.darknya.setting.ConfigManager.loadAll()
    ...
    fun saveAll(): Boolean {
        var success = catx.feitu.darknya.setting.ConfigManager.saveAll()
