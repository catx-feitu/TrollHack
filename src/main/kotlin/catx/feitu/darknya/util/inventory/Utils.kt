...
fun catx.feitu.darknya.event.SafeClientEvent.equipBestTool(blockState: IBlockState) {
    findBestTool(blockState)?.let {
        swapToSlot(it)
    }
}

fun catx.feitu.darknya.event.SafeClientEvent.findBestTool(blockState: IBlockState): Slot? {
    var maxSpeed = 0.0f
 ...
 */
fun catx.feitu.darknya.event.SafeClientEvent.removeHoldingItem() {
 ...
 */
fun catx.feitu.darknya.event.SafeClientEvent.clickSlot(windowID: Int, slot: Slot, mouseButton: Int, type: ClickType): Short {
 ...
 * @return Transaction id
 */
fun catx.feitu.darknya.event.SafeClientEvent.clickSlot(windowID: Int, slot: Int, mouseButton: Int, type: ClickType): Short {
...
private fun catx.feitu.darknya.event.SafeClientEvent.getContainerForID(windowID: Int): Container? {
