...
inline fun catx.feitu.darknya.event.SafeClientEvent.inventoryTaskNow(block: InventoryTask.Builder.() -> Unit) =
...
inline fun catx.feitu.darknya.module.AbstractModule.inventoryTask(block: InventoryTask.Builder.() -> Unit) =
    InventoryTask.Builder()
        .apply {
...
class InventoryTask private constructor(
    ...
    fun runTask(event: catx.feitu.darknya.event.SafeClientEvent): StepFuture? {
