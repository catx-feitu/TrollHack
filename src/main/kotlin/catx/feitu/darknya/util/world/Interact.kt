...
fun catx.feitu.darknya.event.SafeClientEvent.checkPlaceRotation(placeInfo: PlaceInfo): Boolean {
...
fun catx.feitu.darknya.event.SafeClientEvent.getPlacement(
    targetPos: BlockPos,
...
fun catx.feitu.darknya.event.SafeClientEvent.getPlacementSequence(
    targetPos: BlockPos,
    vararg options: PlacementSearchOption?
...
fun interface PlacementSearchOption {
    fun catx.feitu.darknya.event.SafeClientEvent.check(from: BlockPos, side: EnumFacing, to: BlockPos): Boolean
...
fun catx.feitu.darknya.event.SafeClientEvent.getClosestSide(pos: BlockPos): EnumFacing {
...
fun catx.feitu.darknya.event.SafeClientEvent.getMiningSide(pos: BlockPos): EnumFacing? {
...
fun catx.feitu.darknya.event.SafeClientEvent.getClosestVisibleSide(pos: BlockPos): EnumFacing? {
    val eyePos = player.eyePosition
 ...
 */
fun catx.feitu.darknya.event.SafeClientEvent.getVisibleSides(pos: BlockPos, assumeAirAsFullBox: Boolean = false): Set<EnumFacing> {
 ...
 */
fun catx.feitu.darknya.event.SafeClientEvent.placeBlock(
    placeInfo: PlaceInfo,
...
fun catx.feitu.darknya.event.SafeClientEvent.isSideVisible(
    eyeX: Double,
    eyeY: Double,
    eyeZ: Double,
    blockPos: BlockPos,
