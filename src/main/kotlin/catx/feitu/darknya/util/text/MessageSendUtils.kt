package catx.feitu.darknya.util.text

import baritone.api.event.events.ChatEvent
import dev.luna5ama.trollhack.TrollHackMod
import dev.luna5ama.trollhack.command.CommandManager
import catx.feitu.darknya.manager.managers.MessageManager
...
object MessageSendUtils {
    ...
    fun catx.feitu.darknya.module.AbstractModule.sendServerMessage(message: String) {
